...
export default function ManageColoursOverlay() {
  ...
  function CheckContrast() {
    ...
    // rgb1 is the background colour, Rgb2 is the tempColour
  ...
  function ApplyTempColour() {
    ...
    if (CheckContrast()) {
      ...
      toast({
        ...
        status: "error",
        position: "top",
        description: "Try a colour between light and dark. (9)",
      });
    }
  }
      ...
      >
        <Stack direction="column" spacing={5}>
          ...
          <InputGroup>
            ...
            <Input
              placeholder="Enter a hexadecimal colour..."
              value={tempColour}
          ...
          <Button onClick={ApplyTempColour} isDisabled={!tempColour}>
            Apply {tempColour ? `#${tempColour}` : "Colour"}
          </Button>
